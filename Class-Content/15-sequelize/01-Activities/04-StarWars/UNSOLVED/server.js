 ...
 *  2. Delete the character from config. In your app folder, create a model folder
 ...
 *  4. Remove all references to the old character file,
 *     and replace it with character.js
 *  5. Use Sequelize methods in place of the character calls
